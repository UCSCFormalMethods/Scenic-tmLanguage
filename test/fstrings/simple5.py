...
hello         : meta.fstring.scenic, source.scenic, string.interpolated.scenic, string.quoted.multi.scenic
...
:f            : meta.fstring.scenic, source.scenic, storage.type.format.scenic
 ...
 times        : meta.fstring.scenic, source.scenic, string.interpolated.scenic, string.quoted.multi.scenic
