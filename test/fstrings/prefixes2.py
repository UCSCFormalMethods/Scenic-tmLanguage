...
some          : source.scenic, string.interpolated.scenic, string.regexp.quoted.single.scenic
{obj}         : source.scenic, string.interpolated.scenic, string.regexp.quoted.single.scenic
...
some          : meta.fstring.scenic, source.scenic, string.interpolated.scenic, string.quoted.raw.single.scenic
{             : constant.character.format.placeholder.other.scenic, meta.fstring.scenic, source.scenic
obj           : meta.fstring.scenic, source.scenic
}             : constant.character.format.placeholder.other.scenic, meta.fstring.scenic, source.scenic
